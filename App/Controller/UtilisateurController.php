...
class UtilisateurController extends Utilisateur {
    ...
    public function addUtilisateur(): void
    {
        ...
        if (isset($_POST["submit"])) {
            ...
            if (
                !empty($_POST["nom_utilisateur"]) and !empty($_POST["prenom_utilisateur"]) and !empty($_POST["pseudo_utilisateur"]) and
                ...
                if ($_POST["password_utilisateur"] == $_POST["confirm_password"]) {
                    ...
                    if (!$this->getUtilisateurByMail()) {
                        ...
                        // Test si le pseudo n'est pas déjà
                        if (!$this->getUtilisateurByPseudo()) {
                            ...
                            if (!empty($_FILES["image_utilisateur"]["tmp_name"])) {
                                ...
                                //déplacer le fichier
                                move_uploaded_file(
                                    $_FILES["image_utilisateur"]["tmp_name"],
                                    $image
                                );
                            }
                        ...
                        } //Test le pseudo est déjà attribué 
                        else {
